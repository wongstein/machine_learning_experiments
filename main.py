...
point_of_view_machine_learning.singleListing("single_listing_optimised_30", features_to_use)
point_of_view_machine_learning.listingCluster("listing_cluster_optimised_30", features_to_use)
point_of_view_machine_learning.fullLocation("full_location_optimised_30", features_to_use)
