...
def fill_training_and_testing_data(testing_dates, training_dates = None, listing_ids = None):
    ...
    for listing_id in all_ids:
        ...
        for day in all_data[listing_id].keys():
            if day >= training_dates['start_date'] and day < testing_dates['start_date']:
...
if __name__ == '__main__':
    ...
    #fullLocation("full_location_frankenstein_normilisation_2")

    #with PCA at 3
    #fullLocation("full_location_normalised_z_standard_PCA_2", "z-standard", 3)
    #
    #
